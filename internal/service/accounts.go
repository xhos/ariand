...
type AccountService interface {
	...
	SetAnchor(ctx context.Context, id int64, bal float64) error
	Balance(ctx context.Context, id int64) (float64, error)
}
...
func (s *acctSvc) SetAnchor(ctx context.Context, id int64, bal float64) error {
	return s.store.SetAccountAnchor(ctx, id, bal)
}

func (s *acctSvc) Balance(ctx context.Context, id int64) (float64, error) {
