...
const (
	CatStatusNone     CategorizationStatus = "none"
	CatStatusAuto     CategorizationStatus = "auto"
	CatStatusAI       CategorizationStatus = "ai"
	CatStatusManual   CategorizationStatus = "manual"
	CatStatusVerified CategorizationStatus = "verified"
)
...
type Transaction struct {
	...
	CatStatus     CategorizationStatus `db:"cat_status"     json:"catStatus"`
	Merchant      *string              `db:"merchant"       json:"merchant,omitempty"`
	UserNotes     *string              `db:"user_notes"     json:"userNotes,omitempty"`
	Suggestions   pq.StringArray       `db:"suggestions"    json:"suggestions" swaggertype:"array,string"`
