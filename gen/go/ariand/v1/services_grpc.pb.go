...
const (
	TransactionService_ListTransactions_FullMethodName      = "/arian.d.v1.TransactionService/ListTransactions"
	TransactionService_GetTransaction_FullMethodName        = "/arian.d.v1.TransactionService/GetTransaction"
	TransactionService_CreateTransaction_FullMethodName     = "/arian.d.v1.TransactionService/CreateTransaction"
	TransactionService_UpdateTransaction_FullMethodName     = "/arian.d.v1.TransactionService/UpdateTransaction"
	TransactionService_DeleteTransaction_FullMethodName     = "/arian.d.v1.TransactionService/DeleteTransaction"
	TransactionService_CategorizeTransaction_FullMethodName = "/arian.d.v1.TransactionService/CategorizeTransaction"
	TransactionService_IdentifyMerchant_FullMethodName      = "/arian.d.v1.TransactionService/IdentifyMerchant"
)
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arian.d.v1.TransactionService",
...
const (
	AccountService_ListAccounts_FullMethodName      = "/arian.d.v1.AccountService/ListAccounts"
	AccountService_GetAccount_FullMethodName        = "/arian.d.v1.AccountService/GetAccount"
	AccountService_CreateAccount_FullMethodName     = "/arian.d.v1.AccountService/CreateAccount"
	AccountService_DeleteAccount_FullMethodName     = "/arian.d.v1.AccountService/DeleteAccount"
	AccountService_SetAnchor_FullMethodName         = "/arian.d.v1.AccountService/SetAnchor"
	AccountService_GetAccountBalance_FullMethodName = "/arian.d.v1.AccountService/GetAccountBalance"
)
...
type AccountServiceClient interface {
	...
	GetAccountBalance(ctx context.Context, in *GetBalanceRequest, opts ...grpc.CallOption) (*GetBalanceResponse, error)
}
...
func (c *accountServiceClient) GetAccountBalance(ctx context.Context, in *GetBalanceRequest, opts ...grpc.CallOption) (*GetBalanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AccountServiceServer interface {
	...
	// RENAMED to avoid collision with DashboardService.GetBalance
	GetAccountBalance(context.Context, *GetBalanceRequest) (*GetBalanceResponse, error)
...
func (UnimplementedAccountServiceServer) GetAccountBalance(context.Context, *GetBalanceRequest) (*GetBalanceResponse, error) {
...
func _AccountService_GetAccountBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).GetAccountBalance(ctx, req.(*GetBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arian.d.v1.AccountService",
...
const (
	CategoryService_ListCategories_FullMethodName = "/arian.d.v1.CategoryService/ListCategories"
	CategoryService_GetCategory_FullMethodName    = "/arian.d.v1.CategoryService/GetCategory"
	CategoryService_CreateCategory_FullMethodName = "/arian.d.v1.CategoryService/CreateCategory"
	CategoryService_UpdateCategory_FullMethodName = "/arian.d.v1.CategoryService/UpdateCategory"
	CategoryService_DeleteCategory_FullMethodName = "/arian.d.v1.CategoryService/DeleteCategory"
)
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arian.d.v1.CategoryService",
...
const (
	DashboardService_GetBalance_FullMethodName = "/arian.d.v1.DashboardService/GetBalance"
	DashboardService_GetDebt_FullMethodName    = "/arian.d.v1.DashboardService/GetDebt"
	DashboardService_GetTrends_FullMethodName  = "/arian.d.v1.DashboardService/GetTrends"
)
...
type DashboardServiceClient interface {
	GetBalance(ctx context.Context, in *DashboardBalanceRequest, opts ...grpc.CallOption) (*DashboardBalanceResponse, error)
	GetDebt(ctx context.Context, in *DashboardDebtRequest, opts ...grpc.CallOption) (*DashboardDebtResponse, error)
	GetTrends(ctx context.Context, in *DashboardTrendsRequest, opts ...grpc.CallOption) (*DashboardTrendsResponse, error)
}
...
func (c *dashboardServiceClient) GetBalance(ctx context.Context, in *DashboardBalanceRequest, opts ...grpc.CallOption) (*DashboardBalanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DashboardBalanceResponse)
...
func (c *dashboardServiceClient) GetDebt(ctx context.Context, in *DashboardDebtRequest, opts ...grpc.CallOption) (*DashboardDebtResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DashboardDebtResponse)
...
func (c *dashboardServiceClient) GetTrends(ctx context.Context, in *DashboardTrendsRequest, opts ...grpc.CallOption) (*DashboardTrendsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DashboardTrendsResponse)
...
type DashboardServiceServer interface {
	GetBalance(context.Context, *DashboardBalanceRequest) (*DashboardBalanceResponse, error)
	GetDebt(context.Context, *DashboardDebtRequest) (*DashboardDebtResponse, error)
	GetTrends(context.Context, *DashboardTrendsRequest) (*DashboardTrendsResponse, error)
...
func (UnimplementedDashboardServiceServer) GetBalance(context.Context, *DashboardBalanceRequest) (*DashboardBalanceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBalance not implemented")
}
func (UnimplementedDashboardServiceServer) GetDebt(context.Context, *DashboardDebtRequest) (*DashboardDebtResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDebt not implemented")
}
func (UnimplementedDashboardServiceServer) GetTrends(context.Context, *DashboardTrendsRequest) (*DashboardTrendsResponse, error) {
...
func _DashboardService_GetBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DashboardBalanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DashboardServiceServer).GetBalance(ctx, req.(*DashboardBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DashboardService_GetDebt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DashboardServiceServer).GetDebt(ctx, req.(*DashboardDebtRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DashboardService_GetTrends_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DashboardServiceServer).GetTrends(ctx, req.(*DashboardTrendsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DashboardService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arian.d.v1.DashboardService",
...
const (
	ReceiptService_UploadReceipt_FullMethodName = "/arian.d.v1.ReceiptService/UploadReceipt"
	ReceiptService_MatchReceipt_FullMethodName  = "/arian.d.v1.ReceiptService/MatchReceipt"
)
...
var ReceiptService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "arian.d.v1.ReceiptService",
